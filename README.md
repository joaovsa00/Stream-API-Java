...
## Projeto para praticar Stream API no JAVA. 

### Abaixo está listado os exercícios que foram feitos.

Para todos os desafios foi utilizado a seguinte lista de números inteiros:
